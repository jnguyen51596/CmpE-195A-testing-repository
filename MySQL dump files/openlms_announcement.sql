...
CREATE TABLE `announcement` (
  ...
  CONSTRAINT `annoucement_member` FOREIGN KEY (`authorID`) REFERENCES `member` (`mID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `annoucement_course` FOREIGN KEY (`courseID`) REFERENCES `course` (`cID`) ON DELETE NO ACTION ON UPDATE NO ACTION
